        ...
        ViewInteraction textView = onView(
                allOf(withText("Info"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Info")));
        ...
        ViewInteraction textView3 = onView(
                allOf(withText("Gender"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView3.check(matches(withText("Gender")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withText("Age"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView4.check(matches(withText("Age")));
        ...
        ViewInteraction textView6 = onView(
                allOf(withText("Medication"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView6.check(matches(withText("Medication")));
        ...
        ViewInteraction textView7 = onView(
                allOf(withText("Blood Group"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView7.check(matches(withText("Blood Group")));
        ...
        ViewInteraction textView8 = onView(
                allOf(withText("Weight"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView8.check(matches(withText("Weight")));
        ...
        ViewInteraction textView9 = onView(
                allOf(withText("Tempereture"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView9.check(matches(withText("Tempereture")));
